...
CraftablePro is using InertiaJS which allow to use `.vue` files for the frontend part of your application instead of Blade templates. You can learn more in [InertiaJS's documentation](https://inertiajs.com/)

## Root template

CraftablePro is using `resources/views/craftable-pro.blade.php` as a root template for InertiaJS to render the frontend part of your application.
...
```php filename="RouteServiceProvider.php" {17-18}
