...
- fix: changed redirect() to Inertia-location
- fix: deleted unused directive
- fix: pagination (delete query page)
- fix: default route
- build(deps-dev): bump postcss from 8.4.20 to 8.4.31
- build(deps): bump @babel/traverse from 7.20.5 to 7.23.2
- fix: hide dropdown
- fix: unable to crop image
...
- Fix: Fixed Wysiwyg upload media
...
- Fix: Multiselect singlelabel
- Fix: multiple auth guards
...
- fix: bug in activeFiltersCount
- fix: centered profile avatar
- fix: placeholder in Multiselect component
- fix: bulk action error
