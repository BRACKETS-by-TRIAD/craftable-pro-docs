...
- Fix: add Vite 4.0 support
- Fix: added right padding for tags, to prevent overflow

### Upgrade Guide

- Run `composer update` to update dependencies
- Remove `craftable-pro.vite.config.js`
- Run `php artisan craftable-pro:install` to publish new config into your project
- Alternatively, just make sure your Vite config looks like [this](/getting-started/vite-configuration#alternatively-use-inline-postcss-configuration)
