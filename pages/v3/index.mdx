...
<Cards>
  <Card icon={<CommandLineIcon />} title="Getting Started" href="/v3/getting-started" />
  <Card icon={<SparklesIcon />} title="Frontend Assets" href="/v3/frontend" />
  <Card icon={<PuzzlePieceIcon />} title="Basic Features" href="/v3/basic-features" />
</Cards>
