...
**Available Locales:** You can set multiple locales, which will be used in the Translations manager (see [Translations](/v3/basic-features/translations)). You can also crate a new ones.
