...
- fix: schema prefix in CRUD generation
- fix: API generator fixes
- fix: update only fillable fields in user edit page
...
- feat: new CLI
- feat: config based generator based on Blueprint
- feat: support for multiple column layouts
- feat: API generator
- feat: dark mode
- feat: enahnced translations config
- feat: Laravel 12 support
- feat: Inertia 2.0.0
- feat: Ziggy v2 support
- feat: don't publish default pages, resolving them automatically
- feat: composer clean Laravel 11
- feat: notifications support
- feat: refactor components to dark mode
- fix: fixing tests
- fix: multiple minor fixes

### [Upgrade Guide](/v3/getting-started/upgrade-guide)

## v2.0.5 - 2024-10-30

### What's Changed

- fix: make date pickers clearable by @strstensky in https://github.com/BRACKETS-by-TRIAD/craftable-pro/pull/452
- feat: added min/max date props by @vsotreshko in https://github.com/BRACKETS-by-TRIAD/craftable-pro/pull/437

## v2.0.4 - 2024-09-28

### What's Changed

- fix: Fixed preserving the state of the form when search applied
- fix: Added validation to onFilesDrop function
- fix: Multiselect improvements
- fix: Fix generator column options
- feat: Register on login when self-register enabled
- feat: Redirect to the previous URL if exists, after login
...
- feat: added ability to select translatable field as an accessor for relation
- feat: in Edit/Create forms, default locale is now taken from the default locale settings
- feat: made 'preserveState' and 'preserveScroll' overridable
- feat: Setting 'selectedLocale' for 'Wysiwyg'
- fix: resolved issues with medialibrary enums during manipulation
...
- fix: set default column type in generator to string
- fix: passing 'disabled' prop to the button component
