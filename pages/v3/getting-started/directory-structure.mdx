...
`resources/craftable-pro/`

This directory contains YAML configuration files used for CRUD generation. You can learn more at [Config Generator docs](/v3/basic-features/config-generator).
