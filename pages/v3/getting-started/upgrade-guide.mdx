...
To correctly load pages from vendor, replace `resolve` part in your `resources/js/craftable-pro/index.tx` to following:
...
resolve: async (name: string) => {
    ...
    const pages = { ...pagesCraftablePro, ...pagesLocal };
