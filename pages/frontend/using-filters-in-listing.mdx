...
First we need to edit generated controller for our model and add columns we want to filter by into the query builder using the `allowedFilters` method. You can learn more about the query builder in the [Spatie's documentation](https://spatie.be/index.php/docs/laravel-query-builder/v5/features/filtering).
...
This is just a bsic example, you can do so much more with filters. Also if you have any trouble getting them to work, feel free to contact us.
