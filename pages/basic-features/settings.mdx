...
**Available Locales:** You can set multiple locales, which will be used in the Translations manager (see [Translations](/basic-features/translations))
...
<Callout type="info">
    Security setting will be introduced soon
</Callout>