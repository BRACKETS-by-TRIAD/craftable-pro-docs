...
<Callout type={"warning"}>
    We are using soft deletes in combination with email uniqueness. Even after the user is deleted he/she won't be able to register with the same email address. Hard delete on the database level has to be done manually.
</Callout>
