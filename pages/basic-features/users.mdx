...
Craftable PRO comes with several handy features for user management.
...
You can deactivate the user by selecting "Access" from the menu and choosing "Deactivate" in the user options.
<br />
...
<Callout type={"default"}>
    We are using soft deletes in combination with email uniqueness. The e-mail address has to be unique, however after the user is deleted, he/she can register again with the same e-mail address even though he/she is currently soft deleted.
</Callout>
