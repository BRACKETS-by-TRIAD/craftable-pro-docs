...
You are able to create a new language on the Settings page (see [Settings](/basic-features/settings)). All you need to do is to add a new locale to multiselect and hit enter.
<br />
<Image alt={'Import translations'} width={300} height={300} src="/images/newLang.png" />
