...
You are able to create a new locale on the Settings page (see [Settings](/basic-features/settings)). All you need to do is to add a new locale to multiselect and hit enter.
